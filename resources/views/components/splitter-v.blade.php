...
>
    ...
    <div x-ref="first" {{ $first->attributes->class(['overflow-y-auto']) }} :style="'width: ' + width1 + 'px'">
        {{ $first }}
    </div>
    ...
    <div x-ref="second" {{ $second->attributes->class(['overflow-y-auto']) }} :style="'width: ' + width2 + 'px'">
        {{ $second }}
    </div>

    ...
    <div class="p-10">
        ...
        <div class="mt-10">
            ...
            <ul class="list-disc ms-5 mb-6">
                <li>In split vertical, when dragging to the left, the first pane view slides to the right.</li>
                <li>In split horizontal, when dragging to the top, the first pane view slides to the bottom.</li>
